...
def Europe(vals, title, ax, label):
...
p1 = Europe(df_results_LH_hw.overall, "Heatwave ", ax[0,0], "Qle")
p2 = Europe(df_results_SH_hw.overall, " ", ax[1,0], "Qh")
p3 = Europe(df_results_NEE_hw.overall, " ", ax[2,0], "NEE")    

# creating baseplots with zoom  
#overall performance LH, SH, NEE
p4 = Europe(df_results_LH_nohw.overall, " Non-heatwave", ax[0,1], " ")
p5 = Europe(df_results_SH_nohw.overall, "  ", ax[1,1], " ")
fig, sc  = Europe(df_results_NEE_nohw.overall, " ", ax[2,1], " ")
plt.tight_layout()

ax[0,0].text(0.04,0.96, "(a)", size = 12,  horizontalalignment='center', 
    verticalalignment='center', transform=ax[0,0].transAxes)
ax[0,1].text(0.04,0.96, "(b)", size = 12,  horizontalalignment='center', 
    verticalalignment='center', transform=ax[0,1].transAxes)

cbar_ax = fig.add_axes([0.9, 0.672, 0.01, 0.305])
cbar_ax2 = fig.add_axes([0.9, 0.012, 0.01, 0.305])
cbar_ax3 = fig.add_axes([0.9, 0.342, 0.01, 0.305])
